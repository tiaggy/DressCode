...
import static me.tiaggy.dresscode.DressCodePlugin.getLogger;
...
public class SkinUtils {
    ...
    public static void deleteSkinData(String keyString) {
        ...
        getLogger().info("Deleted " + filesDeleted + " skin data files for: " + keyString);
    }
        ...
        if (defaultSkin == null) {
            ...
            while (texture == null) {
                try {
                    ...
                    getLogger().warning("Failed to get skin data for: " + skinFileName);
                }
            }
    ...
    private static void saveSkinData(String fileName, JsonObject skinData) {
        ...
        try (FileWriter fileWriter = new FileWriter(skinDataFolder + fileName + ".json")) {
            ...
            getLogger().severe("Failed to save skin data: " + e.getMessage());
        }
    }
}
